...
?>
	...
	Upcoming Events:
		...
		<?php
		$result1 = mysql_query("SELECT * from Event_Details WHERE Event_Flag = 1 ORDER BY Event_date") or die("Error ".mysql_error());
	...
	Expired Events:
		...
		<?php
		$result3 = mysql_query("SELECT * from Event_Details where Event_Flag = 0 ORDER BY Event_date") or die("Error ".mysql_error());
